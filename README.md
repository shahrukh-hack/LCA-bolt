...
[![D3 Sankey](https://img.shields.io/badge/D3-Sankey_Diagrams-F9A03F?style=flat-square&logo=d3.js)](https://d3js.org/)
[![VisX](https://img.shields.io/badge/VisX-Airbnb_Charts-FC4C02?style=flat-square)](https://airbnb.io/visx)
[![Tailwind CSS](https://img.shields.io/badge/Tailwind-3.4-38B2AC?style=flat-square&logo=tailwind-css)](https://tailwindcss.com/)

<br />

An advanced **Life Cycle Assessment (LCA) Analysis Engine** for renewable wind energy infrastructure. Evaluates cradle-to-grave environmental impacts, material circularity, and carbon flows across the entire turbine lifecycle.
